...
public class PlagiarismDetector {
	...
	public static Map<String, Integer> detectPlagiarism(String dirName, int windowSize, int threshold) {
		...
		String[] files1 = dirFile.list();
		List<String> files = new ArrayList<String>(Arrays.asList(files1));
	...
	public static Map<String, Integer> sortResults1(Map<String, Integer> possibleMatches) {
		...
		List<Map.Entry<String, Integer>> list = new ArrayList<>(possibleMatches.entrySet());
